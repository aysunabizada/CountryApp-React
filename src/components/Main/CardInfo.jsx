...
function CardInfo() {
    return (
        <div classNameName="py-6 m-auto min-h-[70vh]">
            <div className="flex flex-col items-center justify-between m-auto mt-8 bg-white border border-gray-200 rounded-md shadow md:flex-row md:w-[60vw] w-[85vw]">
            ...
            <div classNameName="text-center py-10">
